<x-admin::layouts.master>
    <div class="p-6">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-primary-500">Categories Management</h1>
            <p class="text-gray-400 mt-2">Manage your game account categories</p>
        </div>
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div class="flex-1">
                            <div class="relative">
                                ...
                                <input type="text" name="search" value="{{ request('search') }}" class="bg-dark-400 border border-dark-200 text-gray-200 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 placeholder-gray-500" placeholder="Search categories by name, slug...">
                            </div>
                        </div>
                        <div class="flex gap-2">
                            @if(request('search'))
                                <a href="{{ route('admin.categories.index') }}" class="inline-flex items-center px-4 py-2 border border-dark-200 rounded-lg text-gray-300 hover:bg-dark-200 transition">
                ...
                <table class="min-w-full divide-y divide-dark-200">
                    ...
                    <tbody class="bg-dark-50 divide-y divide-dark-200">
                        ...
                        <tr class="hover:bg-dark-200 transition">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-200">{{ $category->slug }}</div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-200 max-w-xs truncate" title="{{ $category->description ?? '-' }}">{{ $category->description ?? '-' }}</div>
                            </td>
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <h3 class="text-lg font-medium text-gray-200 mb-1">No categories found</h3>
                                    <p class="text-gray-400">Get started by creating a new category</p>
                                    <div class="mt-4">
                                        <a href="{{ route('admin.categories.create') }}" class="inline-flex items-center px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-lg transition duration-200">
