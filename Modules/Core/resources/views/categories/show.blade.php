<x-admin::layouts.master>
    <div class="p-6">
        <div class="mb-6">
            ...
            <p class="text-gray-600">Detailed information about the category</p>
        </div>
                ...
                <div class="p-6 border-b">
                    <div class="flex justify-between items-start">
                        ...
                        <div class="flex space-x-3">
                            <a href="{{ route('admin.categories.edit', $category->id) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h3 class="text-sm font-medium text-gray-500 uppercase tracking-wider">Category Name</h3>
