<x-admin::layouts.master>
    <div class="p-6">
        <div class="mb-6">
            <h1 class="text-3xl font-bold text-primary-500">User Activity Report</h1>
            <p class="text-gray-400">View rental activity for all platform users</p>
        </div>
                ...
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div class="flex-1">
                        <div class="relative">
                            ...
                            <input type="text" id="search" class="bg-dark-400 border border-dark-200 rounded-lg text-gray-300 hover:bg-dark-200 sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5" placeholder="Search users...">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table class="min-w-full divide-y divide-dark-200">
                    ...
                    <tbody class="bg-dark-50 divide-y divide-dark-200">
                        ...
                        <tr class="hover:bg-dark-200 transition">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-200">{{ $user->rentals_count }} rentals</td>
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-gray-400">No users have registered on the platform yet</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
